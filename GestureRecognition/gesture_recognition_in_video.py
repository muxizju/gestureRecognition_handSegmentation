...
if __name__ == '__main__':
    ...
    cap = cv2.VideoCapture("20180328_123451.mp4")
    if not cap.isOpened():
    ...
    print mfps
    vWriter = cv2.VideoWriter('out.mp4', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), mfps, size)
    ...
    while True:
        ...
        if im_width < im_height:
            cv2.transpose(image_np, image_np)
        # im_width=1280
        # im_height=720
        ...
        detector_utils.draw_box_on_image(
            num_hands_detect, args.score_thresh, scores, boxes, im_width, im_height, image_np, classes)
